...
async function callIndependentReviewer(
  ...
  const reviewPrompt = `Ты — независимый аналитик заявок. Прочитай заявку из Jira и определи:
...
ВАЖНО: Будь консервативен. Лучше отклонить сомнительное действие, чем пропустить ошибку.
...
- "Убрать НП", "снять наложку" → action: "update_payment" с payment: {"cod_payment": 0, "payment_type": null, "payment_method": null, "cash_sum": null}
- Когда cod_payment указан — НЕ ТРОГАЙ payment_type, payment_method и cash_sum!

...
10. ВОССТАНОВЛЕНИЕ ЗАКАЗА (action: "restore_order") — ВОССТАНОВИТЬ отменённый заказ. Фразы: "восстановить", "вернуть в работу", "верните заказ", "верните обратно"
...
- "Вернуть в работу" / "верните заказ" → restore_order!

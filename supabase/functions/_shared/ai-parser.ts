...
2. Какие номера накладных упоминаются? (формат KXT..., SP..., SLQ... или чисто цифровой 12-15 цифр)
...
3. НОМЕР НАКЛАДНОЙ может быть в теме или описании. Форматы: буквы + цифры (KXT..., SP..., SLQ...) ИЛИ чисто цифровой номер из 12-15 цифр (например 950964874695000).

...
5. СМЕНА НАПРАВЛЕНИЯ (action: "change_direction") — изменить ГОРОД НАЗНАЧЕНИЯ. Формат "Город1 - Город2" или "Город1-Город2" = change_direction на Город2!
...
- "Город1 - Город2" / "Город1-Город2" = change_direction на Город2!
